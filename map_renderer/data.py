...
# Ported to Python 3 / Pillow

import os

_DATA = os.path.join(os.path.dirname(__file__), 'data')

IMAGE_NAMES = os.path.join(_DATA, 'mapNames.png')
IMAGE_MAP = os.path.join(_DATA, 'in.png')
IMAGE_ARMY = os.path.join(_DATA, 'army.png')
IMAGE_FLEET = os.path.join(_DATA, 'fleet.png')
...
UNALIGNED = [
    'spa', 'por', 'naf', 'tun', 'hol', 'bel', 'nor', 'swe', 'den',
    'rum', 'bul', 'ser', 'alb', 'gre',
]
